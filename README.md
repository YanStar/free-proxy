...
| 文件 | 格式 | 数量 | 说明 |
|------|------|------|------|
| [`http.txt`](http.txt) | `ip:port` | 3,550 | HTTP 代理列表 |
| [`http_url.txt`](http_url.txt) | `http://ip:port` | 3,550 | HTTP 代理，完整 URL 格式 |
...
| [`elite_http_url.txt`](elite_http_url.txt) | `http://ip:port` | 2,023 | 高匿 HTTP 代理 |
| [`elite_socks5_url.txt`](elite_socks5_url.txt) | `socks5://ip:port` | 248 | 高匿 SOCKS5 代理 |
