...
| 文件 | 格式 | 数量 | 说明 |
|------|------|------|------|
| [`http.txt`](http.txt) | `ip:port` | 3,899 | HTTP 代理列表 |
| [`http_url.txt`](http_url.txt) | `http://ip:port` | 3,899 | HTTP 代理，完整 URL 格式 |
...
| [`socks5.txt`](socks5.txt) | `ip:port` | 618 | SOCKS5 代理列表 |
| [`socks5_url.txt`](socks5_url.txt) | `socks5://ip:port` | 618 | SOCKS5 代理，完整 URL 格式 |
...
| 文件 | 格式 | 数量 | 说明 |
|------|------|------|------|
| [`all.txt`](all.txt) | `ip:port` | 5,318 | 所有代理 (未验证) |
| [`all.json`](all.json) | JSON | 5,318 | 所有代理详细信息 |
