...
> Last Updated: `2025-12-24 00:01:19 CST`
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`http.txt`](http.txt) | `ip:port` | 3,160 | HTTP proxy list |
| [`http_url.txt`](http_url.txt) | `http://ip:port` | 3,160 | HTTP proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`socks4.txt`](socks4.txt) | `ip:port` | 1,057 | SOCKS4 proxy list |
| [`socks4_url.txt`](socks4_url.txt) | `socks4://ip:port` | 1,057 | SOCKS4 proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`elite.txt`](elite.txt) | `ip:port` | 1,800 | Elite proxies, won't expose your real IP |
| [`elite.json`](elite.json) | JSON | 1,800 | Elite proxies with details (country, speed, etc.) |
| [`elite_http_url.txt`](elite_http_url.txt) | `http://ip:port` | 1,658 | Elite HTTP proxies |
