...
> Last Updated: `2025-12-23 07:01:21 CST`
...
|------|--------|-------|-------------|
| [`realtime_verified.txt`](realtime_verified.txt) | `ip:port` | 139 | ⭐ **Realtime verified** working proxies, fewer but high quality |
| [`realtime_verified_url.txt`](realtime_verified_url.txt) | `http://ip:port` | 139 | Same as above, full URL format, can be directly used in software |
| [`realtime_verified.json`](realtime_verified.json) | JSON | 139 | Same as above, includes response time and other details |

### 📋 HTTP/HTTPS Proxies

| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`http.txt`](http.txt) | `ip:port` | 3,548 | HTTP proxy list |
| [`http_url.txt`](http_url.txt) | `http://ip:port` | 3,548 | HTTP proxies, full URL format |
| [`https.txt`](https.txt) | `ip:port` | 91 | HTTPS proxy list |
| [`https_url.txt`](https_url.txt) | `https://ip:port` | 91 | HTTPS proxies, full URL format |

### 🧦 SOCKS Proxies

| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`socks4.txt`](socks4.txt) | `ip:port` | 852 | SOCKS4 proxy list |
| [`socks4_url.txt`](socks4_url.txt) | `socks4://ip:port` | 852 | SOCKS4 proxies, full URL format |
| [`socks5.txt`](socks5.txt) | `ip:port` | 428 | SOCKS5 proxy list |
| [`socks5_url.txt`](socks5_url.txt) | `socks5://ip:port` | 428 | SOCKS5 proxies, full URL format |
...
| [`elite_http_url.txt`](elite_http_url.txt) | `http://ip:port` | 1,694 | Elite HTTP proxies |
| [`elite_socks5_url.txt`](elite_socks5_url.txt) | `socks5://ip:port` | 63 | Elite SOCKS5 proxies |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`all.txt`](all.txt) | `ip:port` | 4,732 | All proxies (unverified) |
| [`all.json`](all.json) | JSON | 4,732 | All proxies with full details |
