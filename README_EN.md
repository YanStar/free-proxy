...
> Last Updated: `2026-01-12 10:01:28 CST`
...
| [`https.txt`](https.txt) | `ip:port` | 146 | HTTPS proxy list |
| [`https_url.txt`](https_url.txt) | `https://ip:port` | 146 | HTTPS proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`all.txt`](all.txt) | `ip:port` | 4,784 | All proxies (unverified) |
| [`all.json`](all.json) | JSON | 4,784 | All proxies with full details |
