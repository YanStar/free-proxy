...
> Last Updated: `2026-01-03 21:01:48 CST`
...
| [`https.txt`](https.txt) | `ip:port` | 108 | HTTPS proxy list |
| [`https_url.txt`](https_url.txt) | `https://ip:port` | 108 | HTTPS proxies, full URL format |

### 🧦 SOCKS Proxies

| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`socks4.txt`](socks4.txt) | `ip:port` | 889 | SOCKS4 proxy list |
| [`socks4_url.txt`](socks4_url.txt) | `socks4://ip:port` | 889 | SOCKS4 proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`elite.txt`](elite.txt) | `ip:port` | 1,960 | Elite proxies, won't expose your real IP |
| [`elite.json`](elite.json) | JSON | 1,960 | Elite proxies with details (country, speed, etc.) |
| [`elite_http_url.txt`](elite_http_url.txt) | `http://ip:port` | 1,865 | Elite HTTP proxies |
| [`elite_socks5_url.txt`](elite_socks5_url.txt) | `socks5://ip:port` | 122 | Elite SOCKS5 proxies |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`all.txt`](all.txt) | `ip:port` | 4,883 | All proxies (unverified) |
| [`all.json`](all.json) | JSON | 4,883 | All proxies with full details |
