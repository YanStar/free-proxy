...
> Last Updated: `2026-01-09 01:01:28 CST`
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`socks4.txt`](socks4.txt) | `ip:port` | 1,143 | SOCKS4 proxy list |
| [`socks4_url.txt`](socks4_url.txt) | `socks4://ip:port` | 1,143 | SOCKS4 proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`elite.txt`](elite.txt) | `ip:port` | 2,464 | Elite proxies, won't expose your real IP |
| [`elite.json`](elite.json) | JSON | 2,464 | Elite proxies with details (country, speed, etc.) |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`all.txt`](all.txt) | `ip:port` | 5,246 | All proxies (unverified) |
| [`all.json`](all.json) | JSON | 5,246 | All proxies with full details |
