...
> Last Updated: `2025-12-20 06:01:38 CST`
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`http.txt`](http.txt) | `ip:port` | 3,079 | HTTP proxy list |
| [`http_url.txt`](http_url.txt) | `http://ip:port` | 3,079 | HTTP proxies, full URL format |
...
| File | Format | Count | Description |
|------|--------|-------|-------------|
| [`elite.txt`](elite.txt) | `ip:port` | 1,913 | Elite proxies, won't expose your real IP |
| [`elite.json`](elite.json) | JSON | 1,913 | Elite proxies with details (country, speed, etc.) |
| [`elite_http_url.txt`](elite_http_url.txt) | `http://ip:port` | 1,784 | Elite HTTP proxies |
